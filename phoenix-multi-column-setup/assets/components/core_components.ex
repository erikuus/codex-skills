defmodule {{web_module}}.CoreComponents do
              ...
              <div id={"#{@id}-content"}>
                <div class={["p-4 sm:p-6 sm:w-full sm:min-w-[400px]", @width_class]}>
                  <div class="sm:flex sm:items-start">
                    <div
                      :if={@icon != []}
                      class="mx-auto flex h-12 w-12 shrink-0 items-center justify-center sm:mx-0 sm:h-10 sm:w-10 sm:mr-4"
                    >
                      {render_slot(@icon)}
                    </div>
                  ...
                  <div
                    ...
                    class="mt-5 sm:mt-4 sm:ml-10 sm:pl-4 sm:flex sm:flex-row-reverse"
                  >
                    <.link
                      :for={cancel <- @cancel}
  ...
  def flash(assigns) do
    ...
    >
      <div class="flex items-start">
        ...
        <button :if={@close} type="button" class="shrink-0 ml-4" aria-label={gettext("close")}>
  ...
  attr :variant, :string, default: "primary", values: ~w(primary secondary dangerous)
    ...
    <%= if @navigate || @patch || @href do %>
      <.link
        ...
        class={[
          ...
          @variant == "dangerous" &&
            "bg-red-600 hover:bg-red-700 text-white active:text-white/80",
          @class
        ]}
        {@rest}
      >
    ...
    <header class={[
      ...
      <div class="min-w-0 flex-1">
        ...
        <p
          ...
          class={["mt-2 mr-4 text-sm leading-6 text-zinc-600", Map.get(subtitle, :class, nil)]}
        >
          {render_slot(@subtitle)}
        </p>
      </div>
      ...
      <div
        :for={actions <- @actions}
        class={[
          "mt-4 flex items-center gap-x-5 md:mt-0 md:ml-4 self-start",
          Map.get(actions, :class, nil)
        ]}
      >
        {render_slot(@actions)}
      </div>
